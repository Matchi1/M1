...
void blend(cv::Mat& image1, cv::Mat& image2)
{
  for(int i = 0; i < image1.rows; i++)
  {
      for(int j = 0; j < image1.cols; j++)
      {
          if(image2.at<cv::Vec3b>(i,j)[3] > 0.0)
          {
              image1.at<cv::Vec3b>(i,j)[0] = image2.at<cv::Vec3b>(i,j)[2];
              image1.at<cv::Vec3b>(i,j)[1] = image2.at<cv::Vec3b>(i,j)[1];
              image1.at<cv::Vec3b>(i,j)[2] = image2.at<cv::Vec3b>(i,j)[0];
          }
      }
  }
}
