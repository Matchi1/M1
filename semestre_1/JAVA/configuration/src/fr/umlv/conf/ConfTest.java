...
public class ConfTest {
	...
	public void confHelperGenerateAll3() {
		var set = ConfHelper.generateAll(ArrayList::new, l -> { l.add("foo"); return l; }, l -> { l.add("bar"); return l; });
	...
	public void confHelperGenerateAllAsStream3() {
		var stream = ConfHelper.generateAllAsStream(ArrayList<String>::new, l -> { l.add("foo"); return l; }, l -> { l.add("bar"); return l; });
