...
build_dir="./tmp_build"
src_dir="./src"
jarname="CoolGraphicsFactory.jar"
interface_provided="fr.uge.poo.paint.ex8.CanvasFactory"
class_providing_the_interface="fr.uge.poo.paint.ex8.CoolGraphicsFactory"
included_classes=("fr.uge.poo.coolgraphics.CoolGraphics" "$interface_provided" "$class_providing_the_interface")


#Option to create a jar compatible with older versions of java
#compile_options="--release 11"
compile_options="--release 17"
